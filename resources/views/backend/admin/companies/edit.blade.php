        ...
        <form action="{{ route('companies.update' , $company->id) }}" method="POST" class="form fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="d-flex col-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <input type="text"  name="name" value="{{ old('name' , $company->name) }}" class="form-control form-control-solid" placeholder="Enter name" >
            ...
            <div class="row">
                ...
                <input type="hidden" name="location" class="form-control" value="{{ old('location' , $company->location) }}" id="location">
