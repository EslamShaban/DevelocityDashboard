            ...
            <div class="row">
                <div class="col-6">            
                    ...
                    <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                        ...
                        <textarea name="desc" class="form-control form-control-solid"  placeholder="Enter desc" rows="7">{{ old('desc') }}</textarea>
                    ...
                    <div class="col-12 mb-10">
                        <div class="form-group">
                            ...
                            <select name="news_types_id" id="news_types_id" class="form-control">
                                ...
                                <option value="{{ $news_type->id }}">{{ $news_type->title }}</option>
                                @endforeach
