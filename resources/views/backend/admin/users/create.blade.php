        ...
        <form action="{{ route('users.store') }}" method="POST" class="form fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="d-flex col-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <input type="text"  name="job_title" value="{{ old('job_title') }}" class="form-control form-control-solid" placeholder="Enter job title" >
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <div class="bs-example">
                            <input type="text" name="kpis" id="#inputTag" data-role="tagsinput">
                        </div>
                    </div>
                </div>
